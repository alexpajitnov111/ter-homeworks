...
![SecureGroups](https://github.com/Muroway/ter-homeworks/blob/main/03/src/Security_groups.png)
...
```
locals {
  ssh_id_rsa = file("~/.ssh/id_rsa.pub")
}
```
...
```yaml
#пришел к такому виду, но все равно не понимаю получить из data disk_id для того чтобы передать его в secondary_disk
